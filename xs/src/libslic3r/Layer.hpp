...
class LayerRegion
{
    ...
    SurfaceCollection unmodified_slices;
...
class Layer {
    ...
    Polylines unrouted_wires; ///< straight wires generated from user-defined rubberbands
                              /// in schematic
    Polylines wires;          ///< final wire trajectories after contour following routing
    ExtrusionEntityCollection wire_extrusions; ///< ordered collection of extrusion paths to generate conductive wires
                                               /// wired must be extruded exactly from start to end points as defined
                                               /// in the ExtrusionEntity object to ensure proper connectivity, reordering
                                               /// is acceptable. Wires must be printed at the end of each layer, no
                                               /// optimization of extruder switching, surrounding channels must be printed
                                               /// prior to the "liquid" conductive material.
                                               /// This ExtrusionObject is located in the Layer class since electric wires
                                               /// are generated independent of regions.
                                               /// (this collection contains only ExtrusionEntityCollection objects)

    Polygons electronic_component_polyons; ///< outlines of cavities for electronic components, required for wire routing
