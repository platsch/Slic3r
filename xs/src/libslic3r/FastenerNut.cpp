...
FastenerNut::FastenerNut(std::string threadSize, std::string type)
{
...
stl_file FastenerNut::generateHexNutBody(double x, double y, double z, double diameter, double height)
{
    stl_file stl;
    stl_initialize(&stl);
    stl_facet facet;
