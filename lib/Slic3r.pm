...
sub thread_cleanup {
    ...
    *Slic3r::ExtrusionPoint::DESTROY         = sub {};
    ...
    *Slic3r::Electronics::HexNut::DESTROY = sub {};
    *Slic3r::Electronics::SquareNut::DESTROY = sub {};
    *Slic3r::Electronics::ElectronicNet::DESTROY = sub {};
    *Slic3r::Electronics::RubberBand::DESTROY = sub {};
