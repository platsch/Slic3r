...
END
    ...
    'quality_speed_ratio' => {
        label   => 'Quality - Speed',
        tooltip => 'Determines the quality of the object. From 0: smallest possible layers to 1: biggest layers within the range of the extruders capabilities.',
        sidetext => '0-1',
        cli     => 'quality-speed-ratio=f',
        type    => 'f',
        min		=> 0,
        max		=> 1,
        default => 0.5,
    ...
    'surface_cusp_ratio' => {
        ...
        tooltip => 'Determines the tradeoff between surface-quality and cusp-quality assessment',
        sidetext => '0-1',
        cli     => 'cusp-surface-ratio=f',
        type    => 'f',
        min		=> 0,
        max		=> 1,
        default => 0.5,
